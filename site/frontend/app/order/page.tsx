    ...
    <div className="min-h-screen bg-[#000814] text-white">
      ...
      <main className="relative z-10 pt-28 pb-24 px-4 md:px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-zinc-400 text-center mb-4 text-base leading-relaxed">
          ...
          <p className="text-zinc-300 text-center mb-10 text-base leading-relaxed">
            Мы не студия дубляжа, мы — твои проводники в мир запретных фантазий. Сделаем быстро, анонимно и именно так, как ты хочешь. Самый большой каталог аудио-грехов в рунете.
          </p>
